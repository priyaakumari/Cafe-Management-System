...
public class PlaceOrder extends javax.swing.JFrame {
    ...
    public PlaceOrder() {
     ...
     public void productNameByCategory(String category){
        ...
        public void validateField(){
            ...
            String customerMobileNumber=textCustMobileNumber.getText();
    ...
    private void initComponents() {
        ...
        textCustMobileNumber = new javax.swing.JTextField();
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(21, 13, 123, -1));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 83, -1, -1));

        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("--");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 86, -1, -1));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 179, -1, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Mobile Number");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 246, -1, -1));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Email");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 319, -1, -1));

        textCustName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textCustNameActionPerformed(evt);
            }
        });
        textCustName.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                textCustNameKeyReleased(evt);
            }
        });
        getContentPane().add(textCustName, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 206, 364, -1));

        textCustMobileNumber.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                textCustMobileNumberKeyReleased(evt);
            }
        });
        getContentPane().add(textCustMobileNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 279, 364, -1));
        ...
        getContentPane().add(textEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 350, 364, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Category");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 110, -1, -1));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(459, 139, 250, -1));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Search");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(459, 179, -1, -1));
        ...
        getContentPane().add(textSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(459, 206, 250, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 250, 250, -1));

        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Name");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(781, 110, -1, -1));
        getContentPane().add(textProName, new org.netbeans.lib.awtextra.AbsoluteConstraints(781, 140, 251, -1));

        jLabel11.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Price");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 110, -1, -1));
        getContentPane().add(textProPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(1075, 140, 250, -1));

        jLabel12.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Quantity");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(781, 179, -1, -1));

        jLabel13.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Total");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(1075, 179, -1, -1));
        getContentPane().add(textProTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(1075, 206, 250, -1));
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(781, 256, -1, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(781, 303, 540, 372));

        jLabel14.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("Grand Total: Rs.");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 690, -1, -1));
        ...
        getContentPane().add(lblGrandTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 690, -1, -1));
        ...
        getContentPane().add(jSpinner1, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 210, 260, -1));
    ...
    private void textCustNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textCustNameActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_textCustNameActionPerformed
    ...
    private void textCustNameKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textCustNameKeyReleased
        // TODO add your handling code here:
        validateField();
    }//GEN-LAST:event_textCustNameKeyReleased

    private void textCustMobileNumberKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textCustMobileNumberKeyReleased
        // TODO add your handling code here:
        validateField();
    }//GEN-LAST:event_textCustMobileNumberKeyReleased
    ...
    private javax.swing.JTextField textCustMobileNumber;
